...
type CartState = {
  ...
  getCurrentDeliveryMethod: () => DeliveryMethodEntity | null | undefined,
  paymentMethods: Array<PaymentMethodEntity>,
  getCurrentPaymentMethod: () => PaymentMethodEntity | null | undefined,
...
export const CartContext = createContext<CartState>({
  ...
  deliveryMethods: [],
  getCurrentDeliveryMethod: () => null,
  paymentMethods: [],
  getCurrentPaymentMethod: () => null,
  error: null,
  setError: () => { },
  setCartInfo: () => { },
  setItemQuantity: () => { },
